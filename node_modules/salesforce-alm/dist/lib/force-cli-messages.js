...
let messages = {
    en_US: {
        ...
        DataBulkUpsertExternalIdDescription: 'the column name of the external ID; if not provided, an arbitrary ID is used',
        DataBulkUpsertExternalIdLongDescription: 'The column name of the external ID. If not provided, an arbitrary ID is used.',
        ...
        SourceOpenHelp: 'If Force.com IDE 2 is installed, ' +
            'the file opens in an embedded browser within the IDE. If Force.com IDE 2 isn’t installed, ' +
