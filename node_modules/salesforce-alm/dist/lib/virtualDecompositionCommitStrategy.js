...
class VirtualDecompositionCommitStrategy extends fineGrainTrackingCommitStrategy_1.FineGrainTrackingCommitStrategy {
    ...
    commit(documents, existingPaths) {
        let newPaths;
        let deletedPaths;
        let updatedPaths;
        [newPaths, updatedPaths, deletedPaths] = super.commit(documents, existingPaths, false /** generateDuplicates */);
        ...
        return [newPaths, updatedPaths, deletedPaths, []]; // TODO implement duplicates detection
    }
