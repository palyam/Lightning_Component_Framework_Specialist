...
exports.retrieveId = function (connection, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (context.flags.where) {
            sobjectid = yield exports.queryByWhere(connection, context.flags.sobjecttype, context.flags.where);
        }
        else {
...
exports.queryByWhere = function queryByWhere(connection, sobjectType, keyValueSequence) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const records = yield connection.sobject(sobjectType).find(queryObject, 'id');
